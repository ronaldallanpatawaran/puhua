  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
	  ...
	  <table id="paymentFees" class="table table-striped table-bordered table-hover">
        ...
        </form><div class="text-center">This extension is &copy; by <a href="http://www.rich-software.eu"> Rich Software</a>.<br/>Checkout our store at <a target="_blank" href="http://www.opencart-extensions.net">www.opencart-extensions.net</a> for other awesome extensions. For updates of this extension you can check <a target="_blank" href="http://www.opencart-extensions.net/checkupdates.php?oc=<?php echo VERSION; ?>&amp;ext=19310&amp;version=2.0.3.1">here</a>.</div>
      </div>
    </div>
  </div>
</div>
