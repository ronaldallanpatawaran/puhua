                    ...
                    <tr id="attribute-row<?php echo $attribute_row; ?>">
                      ...
                      <td class="text-left"><?php foreach ($languages as $language) { ?>
                        <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
                          <textarea name="product_attribute[<?php echo $attribute_row; ?>][product_attribute_description][<?php echo $language['language_id']; ?>][text]" id="input-attribute<?php echo $attribute_row; ?>-<?php echo $language['language_id']; ?>" rows="5" placeholder="<?php echo $entry_text; ?>" class="form-control"><?php echo isset($product_attribute['product_attribute_description'][$language['language_id']]) ? $product_attribute['product_attribute_description'][$language['language_id']]['text'] : ''; ?></textarea>
                        </div>
                        <?php } ?></td>
...
<?php $row = 0; foreach ($product_attributes as $product_attribute) { ?>
<?php foreach ($languages as $language) { ?>
$('#input-attribute<?php echo $row; ?>-<?php echo $language['language_id']; ?>').summernote({height: 150});
<?php } ?>
<?php $row++; } ?>
//--></script> 
  <script type="text/javascript"><!--
...
function addAttribute() {
  ...
  <?php foreach ($languages as $language) { ?>
  $('#input-attribute' + attribute_row + '-<?php echo $language['language_id']; ?>').summernote({height: 150});
  <?php } ?>
