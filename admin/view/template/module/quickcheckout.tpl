...
<div id="content">
  ...
  <div class="container-fluid">
	...
	<div style="color:#222222;text-align:center;display:none;"><?php echo $heading_title; ?> v<?php echo $version; ?> by <a href="http://www.marketinsg.com" target="_blank">MarketInSG</a></div>
  </div>
</div>
