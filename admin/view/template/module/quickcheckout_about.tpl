...
<?php if (!$order_id) { ?>
<div style="position:fixed;height:100%;width:100%;z-index:1;background:rgba(255,255,255,0.9);top:0;left:0;display:none;">
  <div class="container">
...
<link rel="stylesheet" type="text/css" href="view/template/module/contactslideout/stylesheet.css" />
