...
<div id="content">
 <div class="page-header">
  ...
  <a class="btn btn-success" onclick="$('#save').val('stay');$('#form-tabs').submit();"><i class="fa fa-check"></i> <?php echo $button_save_stay; ?></a>
  <?php } ?>
          ...
          <div class="panel panel-default">
           ...
           <?php if (isset($section['groups'])) { ?>
               ...
               <div class="tab-content">
                ...
                <button type="button" class="btn btn-danger pull-right" onclick="removeGroup(<?php echo $section_row; ?>, <?php echo $group_row; ?>);"><?php echo $button_remove; ?></button>
...
function addGroup( section_row) {
	...
	html += '</div>';
	<?php } ?>
	html += '<button type="button" class="btn btn-danger pull-right" onclick="removeGroup('+ section_row +',' + group_row +');"><?php echo $button_remove; ?></button>';
