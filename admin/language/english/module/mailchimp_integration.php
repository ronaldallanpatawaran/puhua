...
$_['help_list_mapping']					= 'For more advanced functionality in mapping lists to different stores, languages, customer groups, and currencies, upgrade to <a target="_blank" href="http://www.opencartx.com/mailchimp-integration-pro">MailChimp Integration Pro</a>.<br /><br />The Pro version also includes the ability to choose which customer fields are mapped to which Merge Tags, allows customers to choose and edit Interest Groups, and gives the option to display address fields in the module box.';

$_['pro_help_list_mapping']				= 'If desired, create a list mapping to subscribe customers to different MailChimp lists, based on their select currency, customer group, language, or store. If there is no eligible list mapping, the default list will be used.';
...
$_['entry_modules_popup']				= 'Display as Pop-up: <div class="help-text">If set to "Yes", you will need to paste a link for the newsletter popup in this format:<br /><code>&lt;a href="javascript:showMailchimpPopup()"&gt;LINK TEXT&lt;a&gt;</code><br />Make sure you do not add any module instances, or the pop-up will not function properly.</div>';
