...
class ControllerModuleSlideshow extends Controller {
	...
	public function index() {
		...
		$data['layout_lists'] = array(
			...
			'fullwidth'   => 'Full width: Forces the slider to adapt width to the browser width.',
			'fullscreen'  => 'Full screen: Forces the slider to adapt width and height to the browser window dimension.',
			'fillwidth'   => 'Fill width: Enables the slider to adapt width to its parent element.',
			'autofill'    => 'Auto-fill: Enables the slider to adapt width and height to its parent element.',
			'partialview' => 'Partial view: It\'s like the boxed layout but nearby slides are always visible.'
		);
