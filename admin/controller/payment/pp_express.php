...
class ControllerPaymentPPExpress extends Controller {
	...
	public function index() {
		...
		} elseif ($this->config->get('pp_express_sandbox_username')) {
			$data['pp_express_sandbox_username'] = $this->config->get('pp_express_sandbox_username');
		} else {
			$data['pp_express_sandbox_username'] = 'sandbox-facilitator_api1.firstcom.com.sg';
		}
		...
		} elseif ($this->config->get('pp_express_sandbox_password')) {
			$data['pp_express_sandbox_password'] = $this->config->get('pp_express_sandbox_password');
		} else {
			$data['pp_express_sandbox_password'] = '1406873466';
		}
		...
		} elseif ($this->config->get('pp_express_sandbox_signature')) {
			$data['pp_express_sandbox_signature'] = $this->config->get('pp_express_sandbox_signature');
		} else {
			$data['pp_express_sandbox_signature'] = 'ADWDE8isW6OZGdTinj7mkL-ozroWAMpcC38pnT6Mc.vvCBCSXvmKClo.';
		}

		if (isset($this->request->post['pp_express_test'])) {
			$data['pp_express_test'] = $this->request->post['pp_express_test'];
		} elseif ($this->config->get('pp_express_test')) {
		...
		} elseif ($this->config->get('pp_express_currency')) {
			$data['pp_express_currency'] = $this->config->get('pp_express_currency');
		} else {
			$data['pp_express_currency'] = 'SGD';
		}
		...
		} elseif ($this->config->get('pp_express_canceled_reversal_status_id')) {
			$data['pp_express_canceled_reversal_status_id'] = $this->config->get('pp_express_canceled_reversal_status_id');
		} else {
			$data['pp_express_canceled_reversal_status_id'] = 9;
		}
		...
		} elseif ($this->config->get('pp_express_completed_status_id')) {
			$data['pp_express_completed_status_id'] = $this->config->get('pp_express_completed_status_id');
		} else {
			$data['pp_express_completed_status_id'] = 5;
		}
		...
		} elseif ($this->config->get('pp_express_denied_status_id')) {
			$data['pp_express_denied_status_id'] = $this->config->get('pp_express_denied_status_id');
		} else {
			$data['pp_express_denied_status_id'] = 8;
		}
		...
		} elseif ($this->config->get('pp_express_expired_status_id')) {
			$data['pp_express_expired_status_id'] = $this->config->get('pp_express_expired_status_id');
		} else {
			$data['pp_express_expired_status_id'] = 14;
		}
		...
		} elseif ($this->config->get('pp_express_failed_status_id')) {
			$data['pp_express_failed_status_id'] = $this->config->get('pp_express_failed_status_id');
		} else {
			$data['pp_express_failed_status_id'] = 10;
		}
		...
		} elseif ($this->config->get('pp_express_pending_status_id')) {
			$data['pp_express_pending_status_id'] = $this->config->get('pp_express_pending_status_id');
		} else {
			$data['pp_express_pending_status_id'] = 1;
		}
		...
		} elseif ($this->config->get('pp_express_processed_status_id')) {
			$data['pp_express_processed_status_id'] = $this->config->get('pp_express_processed_status_id');
		} else {
			$data['pp_express_processed_status_id'] = 15;
		}
		...
		} elseif ($this->config->get('pp_express_refunded_status_id')) {
			$data['pp_express_refunded_status_id'] = $this->config->get('pp_express_refunded_status_id');
		} else {
			$data['pp_express_refunded_status_id'] = 11;
		}
		...
		} elseif ($this->config->get('pp_express_reversed_status_id')) {
			$data['pp_express_reversed_status_id'] = $this->config->get('pp_express_reversed_status_id');
		} else {
			$data['pp_express_reversed_status_id'] = 12;
		}
		...
		} elseif ($this->config->get('pp_express_voided_status_id')) {
			$data['pp_express_voided_status_id'] = $this->config->get('pp_express_voided_status_id');
		} else {
			$data['pp_express_voided_status_id'] = 16;
		}
