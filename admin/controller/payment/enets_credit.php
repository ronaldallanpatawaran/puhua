...
class ControllerPaymentEnetsCredit extends Controller
{
    ...
    public function index()
    {
        ...
        $this->response->setOutput($this->load->view('payment/enets_credit.tpl', $data));
    }
    protected function validate()
    {
        if (!$this->user->hasPermission('modify', 'payment/' . $this->code)) {
            $this->error['warning'] = $this->language->get('Warning: You do not have permission to modify payment eNETS (Credit)!');
        }
        return !$this->error;
    }
