...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_tw_url'] = $this->language->get('entry_tw_url');
		$data['entry_ig_url'] = $this->language->get('entry_ig_url');
		...
		$data['entry_admin_logo'] = $this->language->get('entry_admin_logo');
		$data['entry_admin_icon'] = $this->language->get('entry_admin_icon');
		...
		$data['entry_auto_generate_seo_url'] = $this->language->get('entry_auto_generate_seo_url');
		...
		$data['entry_http_username'] = $this->language->get('entry_http_username');
		$data['entry_http_password'] = $this->language->get('entry_http_password');
		...
		$data['help_auto_generate_seo_url'] = $this->language->get('help_auto_generate_seo_url');
		...
		$data['tab_http'] = $this->language->get('tab_http');
		...
		if (isset($this->request->post['config_fb_url'])) {
			$data['config_fb_url'] = $this->request->post['config_fb_url'];
		} else {
			$data['config_fb_url'] = $this->config->get('config_fb_url');
		}

		if (isset($this->request->post['config_tw_url'])) {
			$data['config_tw_url'] = $this->request->post['config_tw_url'];
		} else {
			$data['config_tw_url'] = $this->config->get('config_tw_url');
		}

		if (isset($this->request->post['config_ig_url'])) {
			$data['config_ig_url'] = $this->request->post['config_ig_url'];
		} else {
			$data['config_ig_url'] = $this->config->get('config_ig_url');
		}
		...
		if (isset($this->request->post['config_auto_generate_seo_url'])) {
			$data['config_auto_generate_seo_url'] = $this->request->post['config_auto_generate_seo_url'];
		} else {
			$data['config_auto_generate_seo_url'] = $this->config->get('config_auto_generate_seo_url');
		}
		...
		if (isset($this->request->post['config_http_username'])) {
			$data['config_http_username'] = $this->request->post['config_http_username'];
		} else {
			$data['config_http_username'] = $this->config->get('config_http_username');
		}

		if (isset($this->request->post['config_http_password'])) {
			$data['config_http_password'] = $this->request->post['config_http_password'];
		} else {
			$data['config_http_password'] = $this->config->get('config_http_password');
		}
