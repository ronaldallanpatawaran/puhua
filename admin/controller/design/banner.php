...
class ControllerDesignBanner extends Controller {
	...
	protected function getForm() {
		$data['heading_title'] = $this->language->get('heading_title');
		$data['column_make_description'] = $this->language->get('column_make_description');
		...
		if (isset($this->request->post['banner_image'])) {
			foreach ($this->request->post['banner_image'] as $banner_image_id => $banner_image) {
				foreach ($banner_image['banner_image_description'] as $language_id => $banner_image_description) {
					...
					if (!isset($banner_image_description['set_description']) || $banner_image_description['set_description'] == ""){
						$this->request->post['banner_image'][$banner_image_id]['banner_image_description'][$language_id]['set_description'] = 0;
					}
				}
			}
		}
