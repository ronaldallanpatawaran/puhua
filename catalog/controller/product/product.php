		...
		if (isset($this->request->get['path'])) {
			...
			if (isset($this->request->get['product_id'])) {
				...
				if ($categories) {
					...
					$category_id = (int)$last_category['category_id'];

					$path_categories = $this->model_catalog_category->getCategoryPath($category_id);
					...
					if ($path_categories) {
						...
						foreach ($path_categories as $key => $value) {

							$array_category[] = $value['path_id'];
							$path = implode("_", $array_category);

							$category_info = $this->model_catalog_category->getCategory($value['path_id']);
