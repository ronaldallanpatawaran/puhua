...
class ControllerPaymentEnetsDebit extends Controller {
    protected function index() {
        ...
        $this->load->model('payment/enets_debit');
		
        $data['amount'] = $this->currency->format($order_info['total'], $order_info['currency_code'], $this->model_payment_enets_debit->getCurrencyValue($this->config->get('enets_debit_default_currency')), false);
