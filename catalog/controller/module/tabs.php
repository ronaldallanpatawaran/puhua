...
class ControllerModuleTabs extends Controller {
	public function index($setting) {
		if (isset($setting['sections'])) {        
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/tabs.tpl')) {
				return $this->load->view($this->config->get('config_template') . '/template/module/tabs.tpl', $data);
			} else {
				return $this->load->view('default/template/module/tabs.tpl', $data);
			}
		}
	}
}