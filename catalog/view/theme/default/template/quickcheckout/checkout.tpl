  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>">
	  ...
	  <?php } ?>
		<?php if ($cart_module) { ?>
		<div id="cart1">
		  <div class="quickcheckout-heading"><i class="fa fa-check-square-o"></i> <?php echo $text_checkout_confirm; ?></div>
	  ...
	  <div class="quickcheckoutmid">
		<div id="terms">
		  <div class="quickcheckout-content text-right"></div>
		</div>
	  </div>
