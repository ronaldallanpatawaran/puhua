...
class ModelCheckoutOrder extends Model {
	...
	public function addOrderHistory($order_id, $order_status_id, $comment = '', $notify = false) {
		...
		if ($order_info) {
			...
			$config_order_status_id = array($this->config->get('config_order_status_id'));
			if (!in_array($order_info['order_status_id'], array_merge($config_order_status_id, $this->config->get('config_processing_status'), $this->config->get('config_complete_status'))) && in_array($order_status_id, array_merge($config_order_status_id, $this->config->get('config_processing_status'), $this->config->get('config_complete_status')))) {
				// Stock subtraction
