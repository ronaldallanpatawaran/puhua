      ...
      <div class="tab-content">
        <?php foreach ($languages as $language) { ?>
            <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                ...
                <div style="padding-top: 5px; padding-bottom: 5px;"><h3 class="addsuperh3<?php echo isset( $news_description[$language['language_id']]['description2']) ? ' active' : ''; ?>" id="hidesdesc<?php echo $language['language_id']; ?>"><?php echo $entry_addsdesc; ?></h3></div>
                <div id="sdesc<?php echo $language['language_id']; ?>"<?php echo isset( $news_description[$language['language_id']]['description2']) ? ' style="display:block !important;"' : ''; ?>>
                        <div class="form-group required">
...
$('#input-descriptions___').attr({height: 300});
<?php } ?>
//--></script> 
<script type="text/javascript"><!--
