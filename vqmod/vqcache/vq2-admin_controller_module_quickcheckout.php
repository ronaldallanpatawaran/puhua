...
if ($this->config->get('config_http_username') && $this->config->get('config_http_password')) { curl_setopt($curl, CURLOPT_USERPWD, $this->config->get('config_http_username') . ":" . $this->config->get('config_http_password')); }
