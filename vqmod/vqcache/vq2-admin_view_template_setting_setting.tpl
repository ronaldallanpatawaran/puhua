      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <?php if ($muser->hasPermission('access','store/general'))  {?>
			...
			<?php if (($muser->hasPermission('access','store/store')) && (!$muser->hasPermission('access','store/general')))  {?>
            <li class="active"><a href="#tab-store" data-toggle="tab"><?php echo $tab_store; ?></a></li>
            <?php } elseif ($muser->hasPermission('access','store/store')) { ?>
            <li><a href="#tab-store" data-toggle="tab"><?php echo $tab_store; ?></a></li>
            <?php } ?>
			
            
			<?php if ($muser->hasPermission('access','store/local'))  {?>
            <li><a href="#tab-local" data-toggle="tab"><?php echo $tab_local; ?></a></li>
            <?php } ?>
			
            
			<?php if ($muser->hasPermission('access','store/option'))  {?>
            <li><a href="#tab-option" data-toggle="tab"><?php echo $tab_option; ?></a></li>
            <?php } ?>
			
            
			<?php if ($muser->hasPermission('access','store/image'))  {?>
            <li><a href="#tab-image" data-toggle="tab"><?php echo $tab_image; ?></a></li>
            <?php } ?>
			
            
			<?php if ($muser->hasPermission('access','store/ftp'))  {?>
            <li><a href="#tab-ftp" data-toggle="tab"><?php echo $tab_ftp; ?></a></li>
            <?php } ?>
			
            
			<?php if ($muser->hasPermission('access','store/mail'))  {?>
            <li><a href="#tab-mail" data-toggle="tab"><?php echo $tab_mail; ?></a></li>
            <?php } ?>
			
            
			<?php if ($muser->hasPermission('access','store/server'))  {?>
            <li><a href="#tab-server" data-toggle="tab"><?php echo $tab_server; ?></a></li>
            <?php } ?>
			
            
			<?php if ($muser->hasPermission('access','store/http'))  {?>
            <li><a href="#tab-http" data-toggle="tab"><?php echo $tab_http; ?></a></li>
            <?php } ?>
			
            
			<?php if ($muser->hasPermission('access','store/google'))  {?>
          ...
          <div class="tab-content">
            ...
            <?php } else { ?>
            <div style="display:none" class="tab-pane" id="tab-general">
            <?php } ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <textarea name="config_geocode" rows="5" placeholder="<?php echo $entry_geocode; ?>" id="input-geocode" class="form-control"><?php echo $config_geocode; ?></textarea>
                </div>
              </div>
              <div class="form-group required">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-fb"><?php echo $entry_fb_url; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_fb_url" value="<?php echo $config_fb_url; ?>" placeholder="<?php echo $entry_fb_url; ?>" id="input-fb" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-tw"><?php echo $entry_tw_url; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_tw_url" value="<?php echo $config_tw_url; ?>" placeholder="<?php echo $entry_tw_url; ?>" id="input-tw" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-ig"><?php echo $entry_ig_url; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_ig_url" value="<?php echo $config_ig_url; ?>" placeholder="<?php echo $entry_ig_url; ?>" id="input-ig" class="form-control" />
                </div>
              </div>
              <?php if ($locations) { ?>
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-image">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-admin-logo"><?php echo $entry_admin_logo; ?></label>
                <div class="col-sm-10"><a href="" id="thumb-admin-logo" data-toggle="image" class="img-thumbnail"><img src="<?php echo $admin_logo; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="config_admin_logo" value="<?php echo $config_admin_logo; ?>" id="input-admin-logo" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-admin-icon"><?php echo $entry_admin_icon; ?></label>
                <div class="col-sm-10"><a href="" id="thumb-admin-icon" data-toggle="image" class="img-thumbnail"><img src="<?php echo $admin_icon; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="config_admin_icon" value="<?php echo $config_admin_icon; ?>" id="input-admin-icon" />
                </div>
              </div>
              <div class="form-group required">
            ...
            <div class="tab-pane" id="tab-server">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_auto_generate_seo_url; ?>"><?php echo $entry_auto_generate_seo_url; ?></span></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($config_auto_generate_seo_url) { ?>
                    <input type="radio" name="config_auto_generate_seo_url" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="config_auto_generate_seo_url" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$config_auto_generate_seo_url) { ?>
                    <input type="radio" name="config_auto_generate_seo_url" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="config_auto_generate_seo_url" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
            ...
            <div class="tab-pane" id="tab-http">
              <fieldset>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-http-username"><?php echo $entry_http_username; ?></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_http_username" value="<?php echo $config_http_username; ?>" placeholder="<?php echo $entry_http_username; ?>" id="input-http-username" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-http-password"><?php echo $entry_http_password; ?></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_http_password" value="<?php echo $config_http_password; ?>" placeholder="<?php echo $entry_http_password; ?>" id="input-http-password" class="form-control" />
                  </div>
                </div>
              </fieldset>
            </div>
