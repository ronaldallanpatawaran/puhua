...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_gallimage_list'] = $this->language->get('text_gallimage_list');
		$data['text_gallimage_category'] = $this->language->get('text_gallimage_category');
		...
		$data['gallimage_category'] = $this->url->link('catalog/gallimage_category', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['openbay_link_amazonus_links'] = $this->url->link('openbay/amazonus/itemlinks', 'token=' . $this->session->data['token'], 'SSL');
                ...
                $data['text_testimonial'] = 'Testimonial';
                         $data['testimonial'] = $this->url->link('catalog/oca_testimonial_pro', 'token=' . $this->session->data['token'], 'SSL');
